...
import type { HermesUsageSummary, UsageBreakdownRow, UsageWindowId } from "@/features/usage/types";
...
export function UsageBrowser({ usage }: { usage: HermesUsageSummary }) {
    ...
    <div className="space-y-8">
      <section className="max-w-4xl">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <RefreshButton loadedAt={usage.loadedAt} />
        </div>
